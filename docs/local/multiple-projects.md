...
3. Download `traefik.yml` file (inside of `docker4wordpress.tar.gz` archive) from the [latest stable release](https://github.com/wodby/docker4wordpress/releases) to the parent dir where _site1_ and _site2_ dirs are
